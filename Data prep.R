...
setwd('/Users/caokailun/Desktop/Concordia/Thesis/chapter II/data')
d1 = read_dta("NLSY79.dta")
write.csv(d1, file = "NLSY79.csv")
d1 = read.csv("NLSY79.csv")

d2 = read_dta("NLSY97.dta")
write.csv(d2, file = "NLSY97.csv")
...
X1 = as.matrix(d1); X1.c = X1[,-c(11:23)]
X2 = as.matrix(d2); X2.c = X2[,-c(11:23)]
